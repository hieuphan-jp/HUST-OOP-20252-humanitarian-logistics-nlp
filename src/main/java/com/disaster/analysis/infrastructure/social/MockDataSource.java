...
import com.disaster.analysis.domain.model.Comment; // Thực thể lưu trữ dữ liệu bình luận
import com.disaster.analysis.domain.model.Post; // Thực thể lưu trữ dữ liệu bài đăng mạng xã hội
